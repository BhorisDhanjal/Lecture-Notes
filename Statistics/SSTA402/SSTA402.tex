...
So this will be a unbiased estimator of $ \sigma^2 $ when $ H_0 $ is true, i.e. $ \sum \alpha_i^2=0 $.
...
\end{align*}
So now we have $ E[MSS_B]=\frac{k}{h-1}\sum_j \beta_j^2+\sigma^2 $. So we have that $ MSS_B $ is an unbiased estimator of $ \sigma^2 $ when $ H_0 $ is true i.e. $ \sum_j \beta_j^2=0. $
