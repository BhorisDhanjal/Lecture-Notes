...
\begin{theorem}
	Let $ y_1(x) $ and $ y_2(x) $ be linearly indepedent solutions of the homogenous equation \ref{def:2ndhomo} on $ I $. Then $ c_1 y_1(x) + c_2 y_2 (x)$ is the general soltuion of equation \ref{def:2ndhomo} on $ I $.
\end{theorem}
\begin{proof}
